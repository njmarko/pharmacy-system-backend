package com.mrsisa.pharmacy.security;

import com.mrsisa.pharmacy.security.filter.JwtRequestFilter;
import com.mrsisa.pharmacy.security.util.RestAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/api/medicine-stocks/medicine/{id}").permitAll()
                .antMatchers("/api/medicines/{id}").permitAll()
